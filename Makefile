...
VERSION     := 01.00
TITLE_ID    := SVBD00004
CONTENT_ID  := IV0000-APOL00004_00-APOLLO0000000PS1
CONTENT_ID  := IV0000-SVBD00004_00-SVBD000000000PS4

# Libraries linked into the ELF.
LIBS        := -lc -lkernel -lc++ -lSceAudioOut -lSceUserService  -lSceSysmodule -lSceFreeType \
               -lScePad -lSceSystemService -lSceSaveData  -lSceNet -lSceNetCtl -lcurl \
               -lSceRegMgr -lSceImeDialog  -lpolarssl -lz -lzip -ljbc -lSQLite
